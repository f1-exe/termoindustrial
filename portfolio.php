...
<head>
	...
	<title>TermoIndustrial | Obras</title>
...
<body>
			...
			<div class="row">
				<!-- <div class="col-md-12">
						<ul class="portfolio-filter text-center">
							...
							<li class="filter" data-filter=".frigopol">Frigopol</li>
							<li class="filter" data-filter=".frigopanel">Frigopanel</li>
							<li class="filter" data-filter=".techopol">Techopol</li>
						</ul>
					</div> -->
				<div id="Container">
	...
	<div class="bg-color our-brand-area ptb-80">
		<div class="container">
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<ul>
					...
					<li>Cámaras frigoríficas industriales</li>
					<li>Cámaras frigoríficas comerciales</li>
					<li>Salas Limpias</li>
				</ul>
			</div>
			<div class="col-lg-6">
